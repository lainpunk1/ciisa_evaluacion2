...
public class proceso extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String strEstudio = request.getParameter("estudio");
        String strID = request.getParameter("id");
        
        Anime ani = new Anime();
        
        ani.setId(Integer.valueOf(strID));
        ani.setNombre(strNombre);
        ani.setEstudio(strEstudio);
        ani.setGenero(strGenero);
        ani.setAutor(strAutor);
